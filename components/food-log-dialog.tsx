...
export function FoodLogDialog({ open, onOpenChange, mealType, date }: FoodLogDialogProps) {
  ...
  const quickFoods = [
    { name: 'Huevos (2 grandes)', calories: 143, fat: 10, protein: 13, carbs: 1 },
    { name: 'Bacon (3 lonchas)', calories: 161, fat: 12, protein: 12, carbs: 0 },
    { name: 'Aguacate (medio)', calories: 161, fat: 15, protein: 2, carbs: 2 },
    { name: 'Pechuga de Pollo (100g)', calories: 165, fat: 4, protein: 31, carbs: 0 },
    { name: 'Salmón (100g)', calories: 208, fat: 13, protein: 20, carbs: 0 },
    { name: 'Queso (30g)', calories: 113, fat: 9, protein: 7, carbs: 0 },
    { name: 'Almendras (28g)', calories: 164, fat: 14, protein: 6, carbs: 3 },
    { name: 'Aceite de Oliva (1 cda)', calories: 119, fat: 14, protein: 0, carbs: 0 },
    { name: 'Mantequilla (1 cda)', calories: 102, fat: 12, protein: 0, carbs: 0 },
    { name: 'Carne Picada (100g)', calories: 250, fat: 17, protein: 26, carbs: 0 },
    { name: 'Brócoli (1 taza)', calories: 55, fat: 1, protein: 4, carbs: 6 },
    { name: 'Espinacas (2 tazas)', calories: 14, fat: 0, protein: 2, carbs: 2 },
  ]
